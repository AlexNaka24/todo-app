...
# GET all todos
@app.get("/mytodos", status_code=status.HTTP_200_OK)
async def read_all(db: db_dependency):
    return db.query(models.Todos).all()

# GET todos by id
@app.get("/mytodos/{todo_id}", status_code=status.HTTP_200_OK)
...
@app.get("/mytodos/priority/", status_code=status.HTTP_200_OK)
...
# POST todos
@app.post("/mytodos/createtodo/", status_code=status.HTTP_201_CREATED)
...
# PUT todos
@app.put("/mytodos/updatetodo/{todo_id}", status_code=status.HTTP_200_OK)
...
# DELETE todos
@app.delete("/mytodos/deletetodo/{todo_id}", status_code=status.HTTP_200_OK)
